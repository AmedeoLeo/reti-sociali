...
from Impl_competitor_bursting_FP import balance,  comp_burst_best_response
...
adv_bots=dict()
adv_bots["test"] = dict()
adv_bots["test"]["x"] = comp_burst_best_response
adv_bots["test"]["y"] = comp_burst_best_response
adv_bots["test"]["z"] = comp_burst_best_response

adv_bots["prova"] = dict()
adv_bots["prova"]["x"] = comp_burst_best_response
adv_bots["prova"]["y"] = comp_burst_best_response
adv_bots["prova"]["z"] = comp_burst_best_response

adv_bots["esame"] = dict()
adv_bots["esame"]["x"] = comp_burst_best_response
adv_bots["esame"]["y"] = comp_burst_best_response
adv_bots["esame"]["z"] = comp_burst_best_response
...
while not done and step < max_step:
        ...
        for query in adv_values.keys():
            ...
            #Execute the VCG auction with the bids computed above
