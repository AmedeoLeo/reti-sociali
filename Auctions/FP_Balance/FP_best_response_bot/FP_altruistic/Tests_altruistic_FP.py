...
from Impl_altruistic_FP import balance,  altruistic_best_response
...
adv_bots=dict()
adv_bots["test"] = dict()
adv_bots["test"]["x"] = altruistic_best_response
adv_bots["test"]["y"] = altruistic_best_response
adv_bots["test"]["z"] = altruistic_best_response

adv_bots["prova"] = dict()
adv_bots["prova"]["x"] = altruistic_best_response
adv_bots["prova"]["y"] = altruistic_best_response
adv_bots["prova"]["z"] = altruistic_best_response

adv_bots["esame"] = dict()
adv_bots["esame"]["x"] = altruistic_best_response
adv_bots["esame"]["y"] = altruistic_best_response
adv_bots["esame"]["z"] = altruistic_best_response
